...
WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_SetByCaller_ComboCount);

WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AttackType_Light);
WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AttackType_Heavy);
