...
void UWarriorFunctionLibrary::BP_DoesActorHaveTag(
    AActor* InActor, FGameplayTag TagToCheck, EWarriorConfirmType& OutConfirmType)
{
    ...
    AActor* InActor, EWarriorValidType& OutValidType)
{
	...
	OutValidType = IsValid(CombatComponent) ? EWarriorValidType::Valid : EWarriorValidType::Invalid;
