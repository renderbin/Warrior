...
UBTTask_RotateToFaceTarget::UBTTask_RotateToFaceTarget()
{
	...
	InTargetToFaceKey.AddObjectFilter(
	    this, GET_MEMBER_NAME_CHECKED(ThisClass, InTargetToFaceKey), AActor::StaticClass());
}
...
bool UBTTask_RotateToFaceTarget::HasReachedAnglePrecision(APawn* QueryPawn, AActor* TargetActor) const
{
	...
	const float AngleDiff = UKismetMathLibrary::DegAcos(FMath::Clamp(DotResult, -1.f, 1.f));
